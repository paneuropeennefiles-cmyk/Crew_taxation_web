...
LANGUAGES = {'Arabic': Language(name='Arabic',
             ...
             'Czech': Language(name='Czech',
                               ...
                               alphabet=u'áčďeěíňóřšťúůýžÁČĎeĚÍŇÓŘŠŤÚŮÝŽ',
             ...
             'French': Language(name='French',
                                ...
                                charsets=['ISO-8859-1', 'ISO-8859-15',
                                          'WINDOWS-1252'],
                                alphabet=u'œaâçeeîïùûêŒaÂÇeeÎÏÙÛÊ',
                                wiki_start_pages=[u'Wikipedia:Accueil_principal',
                                                  u'Bœuf (animal)']),
             ...
             'Hungarian': Language(name='Hungarian',
                                   ...
                                   use_ascii=False,
                                   charsets=['ISO-8859-2', 'WINDOWS-1250'],
                                   alphabet=(u'abcdefghijklmnoprstuvzáeíóöőúüű'
                                             u'ABCDEFGHIJKLMNOPRSTUVZÁeÍÓÖŐÚÜŰ'),
             ...
             'Portuguese': Language(name='Portuguese',
                                 ...
                                 charsets=['ISO-8859-1', 'ISO-8859-15',
                                           'WINDOWS-1252'],
                                 alphabet=u'ÁÂÃaÇeÊÍÓÔÕÚáâãaçeêíóôõú',
                                 wiki_start_pages=[u'Wikipedia:Página_principal']),
             ...
             'Slovak': Language(name='Slovak',
                                ...
                                use_ascii=True,
                                charsets=['ISO-8859-2', 'WINDOWS-1250'],
                                alphabet=u'áäčďeíĺľňóôŕšťúýžÁÄČĎeÍĹĽŇÓÔŔŠŤÚÝŽ',
